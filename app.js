...
Object.assign(FOCUS_LABEL_BG, {
    ...
    'Full Body + Core': 'Цяло тяло и корем',
    'Upper Body + Core': 'Горна част и корем',
    'Lower Body + Core': 'Долна част и корем',
    'Full Body (Chest Emphasis)': 'Цяло тяло с акцент върху гърди',
    'Full Body (Leg Emphasis)': 'Цяло тяло с акцент върху крака',
    'PUSH + CORE': 'Гърди, рамене, трицепс и корем',
    'PULL + CORE': 'Гръб, бицепс и корем',
    'LEGS + CORE': 'Крака и корем'
});
...
Object.assign(EXERCISE_LABEL_BG, {
    ...
    'Dumbbell Bicep Curl': 'Сгъване за бицепс с дъмбел',
    'Cable Woodchoppers': 'Дървосекач на скрипец',
    'Hanging Leg Raises': 'Повдигане на крака от вис',
    'Back Squat': 'Клек с щанга',
    'Goblet Squat': 'Гоблет клек',
    'Split Squat': 'Сплит клек',
    'Incline Barbell Bench Press': 'Наклонен лег с щанга',
    'Ab Wheel Rollout': 'Рол-аут с колело за корем',
    'Russian Twists': 'Руски усуквания',
    Dips: 'Кофи',
    'Leg Curl Machine': 'Машина за сгъване за бедро',
    'Push-Up': 'Лицева опора',
    'Feet-Elevated Push-Up': 'Лицева опора с повдигнати крака',
    'Resistance Band Chest Press': 'Разтласкване за гърди с ластик',
    'Backpack Floor Press': 'Лег от пода с раница',
    'Decline Push-Up': 'Лицева опора с наклон надолу',
    'Tempo Push-Up': 'Лицева опора с контролирано темпо',
    'Resistance Band Row': 'Гребане с ластик',
    'Inverted Row': 'Обратно гребане',
    'One-Arm Backpack Row': 'Едностранно гребане с раница',
    'Doorway Towel Row': 'Гребане с кърпа на врата',
    'Chin-Ups': 'Набирания подхват',
    'Pike Push-Up': 'Пайк лицеви опори',
    'Band Overhead Press': 'Раменна преса с ластик',
    'Single-Arm Backpack Press': 'Едностранна преса с раница',
    'Wall Pike Press': 'Пайк преса до стена',
    'Handstand Hold': 'Стойка на ръце със задържане',
    'Single-Leg Romanian Deadlift': 'Еднокрака румънска тяга',
    'Glute Bridge': 'Глутеус бридж',
    'Backpack Romanian Deadlift': 'Румънска тяга с раница',
    'Hamstring Walkout': 'Хамстринг уолкаут',
    'Dead Bug': 'Дед бъг',
    'Side Plank': 'Страничен планк',
    'Hollow Body Hold': 'Холоу холд',
    'Resistance Band Bicep Curl': 'Сгъване за бицепс с ластик',
    'Backpack Curl': 'Сгъване за бицепс с раница',
    'Towel Bicep Curl Isometric': 'Изометрично сгъване с кърпа за бицепс',
    'Resistance Band Tricep Pressdown': 'Изтласкване за трицепс с ластик',
    'Overhead Band Tricep Extension': 'Надглавно разгъване за трицепс с ластик',
    'Bench Dips': 'Кофи на пейка',
    'Diamond Push-Up': 'Диамантени лицеви опори',
    'Resistance Band Lat Pulldown': 'Издърпване с ластик за гръб',
    'Reverse Pec Deck': 'Обратен пек-дек',
    'Resistance Band Face Pull': 'Фейс пул с ластик',
    'Bent-Over Rear Delt Raise': 'Разтваряне за задно рамо в наклон',
    'Prone Y-T-W Raises': 'Y-T-W повдигания от лег',
    'Scapular Wall Slides': 'Плъзгане по стена за лопатки',
    'Reverse Lunge': 'Обратен напад',
    'Step-Up': 'Стъпване на платформа',
    'Nordic Curl': 'Нордик сгъване',
    'Towel Hamstring Curl': 'Сгъване за бедро с кърпа',
    'Single-Leg Calf Raise': 'Повдигане на пръсти на един крак',
    'Resistance Band Chest Fly': 'Флайс за гърди с ластик',
    'Hip Hinge Drill': 'Хип хиндж техника',
    'Pallof Press': 'Палоф преса',
    'High Knees': 'Високи колена',
    'SkiErg Sprint': 'Ски-ерг интервал',
    'Jump Squats': 'Скокови клекове',
    'Fast Mountain Climbers': 'Бързи маунтин клаймбъри',
    'Assault Bike Sprint': 'Спринт на Assault Bike',
    'Sled Push': 'Бутане на шейна',
    'Bear Crawl': 'Мечешко ходене',
    'Skater Hops': 'Скокове тип кънкьор'
});
...
const PLAN_TEXT_EXACT_BG = {
    ...
    'Ensure proper warm-up and cool-down to prevent injury.': 'Направи добра загрявка и кратко отпускане след тренировка, за да намалиш риска от контузии.',
    'Adjust intensity if any joint pain occurs': 'При болка в ставите намали тежестта или обема още в същата тренировка.',
    'Aim to consume at least 3 liters of water daily, increase on training days': 'Гони поне 3 литра вода на ден, а в тренировъчни дни и малко повече.',
    'Increase load or reps weekly by 5% if all sets completed with good form': 'Ако покриваш всички серии с чиста техника, качвай леко тежестта или повторенията всяка седмица.',
    'Add 2-5% weight or 1-2 reps to compound lifts, add 1-3 reps to isolation exercises': 'На базовите упражнения добавяй 2–5% тежест или 1–2 повторения, а на изолиращите 1–3 повторения.',
    'If user reports persistent joint pain or missed 2+ sessions due to fatigue, reduce volume by 50% for 1 week': 'Ако има постоянна ставна болка или изпуснеш 2+ тренировки заради умора, свали обема с около 50% за 1 седмица.',
    'Maintain neutral spine during deadlifts and squats.': 'Дръж неутрален кръст при тягите и клековете.',
    'Avoid pushing through sharp pain, differentiate pain from fatigue.': 'Не тренирай през остра болка и различавай болката от нормалната умора.',
    'Consume adequate nutrition to support recomposition goals.': 'Храни се достатъчно добре, за да подкрепиш рекомпозицията и възстановяването.',
...
const PLAN_TEXT_FRAGMENT_BG = [
    ...
    [/Greek yogurt/gi, 'кисело мляко'],
    [/гръцко кисело мляко/gi, 'кисело мляко'],
    [/yogurt/gi, 'кисело мляко'],
    [/йогурт/gi, 'кисело мляко'],
    ...
    [/easy-to-digest carbs \+ protein/gi, 'лесни за храносмилане въглехидрати + протеин'],
    [/easy protein/gi, 'лесен за храносмилане протеин'],
    [/Example:/gi, 'Пример:'],
    [/Optional caffeine/gi, 'Кофеин по желание'],
    [/Caffeine is optional/gi, 'Кофеинът е по желание'],
    [/if tolerated/gi, 'ако ти понася'],
    [/if it sits well with you/gi, 'ако ти понася добре'],
    [/protein \+ carbs for recovery/gi, 'протеин + въглехидрати за възстановяване'],
    [/Choose whole-food meals when possible/gi, 'По възможност избирай пълноценна храна'],
    [/Prefer whole-food meals when possible/gi, 'По възможност избирай пълноценна храна'],
    [/Aim to consume at least 3 liters of water daily, increase on training days/gi, 'Гони поне 3 литра вода на ден, а в тренировъчни дни и малко повече'],
    [/Increase load/gi, 'Увеличавай тежестта'],
    [/good form/gi, 'чиста техника'],
    [/compound lifts/gi, 'базовите упражнения'],
    [/isolation exercises/gi, 'изолиращите упражнения'],
    [/increase on training days/gi, 'а в тренировъчни дни и малко повече'],
    [/Maintain neutral spine during deadlifts и squats\./gi, 'Дръж неутрален кръст при тягите и клековете.']
];
